...
import javax.swing.*;
//Класс создается наследованием класса JOptionPane
class MyPane extends JOptionPane {
    ...
    static void showMessage(String txt,String title){
        //Вызов статического метода shwMessageDialog() из
        //класса JOptionPane
        showMessageDialog(null,txt,title,PLAIN_MESSAGE,new ImageIcon("src/main/resources/pictures/giraffe.jpeg"));
    }
...
class ExtendingJOptionPaneDemo {
    public static void main(String[] args) {
        ...
        //Переменная для запсии числового значения:
        int number;
        //Отображение диалогового окна с полем ввода
        //и считывание целочислительного значения:
