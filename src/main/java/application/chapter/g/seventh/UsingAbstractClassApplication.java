...
abstract class ColoredFigure{
    ...
    //параметра, определяющего характреный размер фигуры:
    String getSizeName() {
        return "сторона";
    }
    //Абстрактные методы:
...
class Circle extends ColoredFigure{
    ...
    //Переопредедение метода, возвращающего результатом
    //название для парметра, определяющего характерный
    //размер фигуры:
    @Override
    String getSizeName(){
        return "радиус";
